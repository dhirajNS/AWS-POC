package com.cloudwatchexample.cloudwatchDemo.service;
...
public class CloudWatchService {
    ...
    private static String logGroupName = "local-cloudwatch-monitor";
    private static String logStreamName = "local-cloudwatch-monitor-stream";
